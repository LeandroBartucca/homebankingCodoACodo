...
public class AccountService {
    ...
    public AccountDto updateAccount(Long id, AccountDto account){
        ...
        if (accountCreated.isPresent()){
            //me traigo la entidad de la bd, esta es la que voy a modificar
            ...
            if (account.getOwner()!=null){
                //si hay un owner en el body me traigo la entidad completa de bd por el id para vincularle ese usuario a la cuenta
